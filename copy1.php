...
$q2="CREATE TABLE $rm ( Row INT(6) UNSIGNED PRIMARY KEY, col1 BIGINT(8) , col2 BIGINT(8) , col3 BIGINT(8) )";

$results=mysqli_query($mysqli,$q2);
if($results===false){
...
{ $q12="INSERT INTO student VALUES('$a1','$rn')";
  mysqli_query($mysqli,$q12);    $a1+=1;
}
while($b1!=$er2)
{ $q12="INSERT INTO student VALUES('$b1','$rn')";
  mysqli_query($mysqli,$q12);    $b1+=1;
}
while($c1!=$er3)
{ $q12="INSERT INTO student VALUES('$c1','$rn')";
  mysqli_query($mysqli,$q12);    $c1+=1;
}
while($g1!=$er4)
{ $q12="INSERT INTO student VALUES('$g1','$rn')";
  mysqli_query($mysqli,$q12);    $g1+=1;
}
...
/*$r="SELECT *FROM back ";
$result = @mysqli_query($mysqli,$r) or die(mysql_error());
...
$rt="SELECT*FROM $rm";
//$result=mysqli_query($mysqli,$rt);
$result = @mysqli_query($mysqli,$rt) or die(mysqli_error($mysqli));
echo "<br>";
