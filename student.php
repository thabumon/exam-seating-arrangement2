...
$q2=mysqli_query($mysqli,$q) or die(mysqli_error($mysqli));

$ro = mysqli_fetch_array($q2);
$rm=$ro['ROOM_NO'];
echo "Room:  $rm<br>";
$q3="SELECT * FROM room$rm";
$result=mysqli_query($mysqli,$q3) or die(mysqli_error($mysqli));
...
{ $q5="SELECT * FROM room$rm WHERE col$i=$r";
  $q6=mysqli_query($mysqli,$q5) or die(mysqli_error($mysqli));
...
$t=1;
 while($t!=$rows)
{  $row = mysqli_fetch_array($mysqli,$result)  ;     //if($t==$rowno['Rows']) echo "<style>td{background-color:green;}</style>";
echo "<tr>";
echo "<td>" . $row['Row'] . "</td>";
echo "<td>" . $row['col1'] . "</td>";
echo "<td>" . $row['col2'] . "</td>";
...
$t=1;
 while($t!=$rows)
 {  $row = mysqli_fetch_array($mysqli,$result)  ;
echo "<tr>";
echo "<td>" . $row['Row'] . "</td>";
echo "<td>" . $row['col1'] . "</td>";
echo "<td>" . $row['col2'] . "</td>";
